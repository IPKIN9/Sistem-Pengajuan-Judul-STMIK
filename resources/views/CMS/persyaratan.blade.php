                        ...
                        <div class="card-body">
                            <form id="formSimpan" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea name="persyaratan" id="persyaratan" class="form-control"
                                            placeholder="Input Persyaratan"
                                            aria-describedby="basic-icon-default-message2"
                                            rows="8">{{$data->persyaratan}}</textarea>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <label class="col-sm-2 col-form-label" for="basic-default-name">Download
                                        File</label>
                                    <div class="col-sm-2">
                                        <a href="{{ asset('storage/format_file/'.$data->format_file) }}"
                                            class="btn rounded-pill btn-outline-primary" id="InfoId" target="_blank"><i
