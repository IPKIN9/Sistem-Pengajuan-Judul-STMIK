                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($SI as $d)
                                            <tr>
                                                ...
                                                <td>{{ $d->tgl_tutup }}</td>
                                                <td>{{ $d->sesi }}</td>
                                                <td>{{ Str::limit($d->persyaratan, 60, '...') }}</td>
                                                <td>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea name="persyaratan" id="persyaratan" class="form-control" placeholder="Input Persyaratan"
                                                    aria-describedby="basic-icon-default-message2" rows="8"></textarea>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="persyaratan" class="form-control"
                                        aria-describedby="basic-icon-default-message2" rows="8">` + data.persyaratan + `</textarea>
                                </div>
                            </div>
                        `);
                    },
