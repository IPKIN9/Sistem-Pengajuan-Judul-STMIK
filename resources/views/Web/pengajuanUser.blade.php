                ...
                <div class="d-flex align-items-end row">
                    <div class="col-sm-7">
                        <div class="card-body">
                            ...
                            <p class="mb-4">
                                Aplikasi ini dibangun agar mempermudah mahasiswa untuk mengajukan judul <span>Proposal
                                    Skripsi</span> pada kampus STMIK Adhi Guna
                            </p>
                        </div>
                    </div>
                        ...
                        <li class="d-flex mb-4 pb-1">
                            ...
                            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                <div class="me-2">
                                    ...
                                    <small class="text-muted">{{ date('d-M', strtotime($d->tgl_buka)) }} Sampai {{
