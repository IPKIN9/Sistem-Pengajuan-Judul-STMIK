                            ...
                            <div class="card-body">
                                <form id="formSimpan">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-3">
                                            <button type="button" id="btnData" data-id="dosen"
                                                class="btn rounded-pill btn-primary">Dosen</button>
                                            <button type="button" id="btnData" data-id="admin"
                                                class="btn rounded-pill btn-primary">Admin</button>
                                        </div>
                                        <div class="col-sm-7">
